...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "104.131.165.132";
	// the port at which the broker is running. 
	private static int				MQTT_BROKER_PORT_NUM      = 1886; //1883
	...
	public static String			MQTT_CLIENT_ID = "EaseInfo";
	public static String			MQTT_CLIENT_ID_SUBSCRIBE = "EaseInfo_Android_Subscribe";
	public static String			MQTT_CLIENT_ID_PUBLISH = "EaseInfo_Android_Publish";
	
	public static String			START_UPLOAD = "START_UPLOAD";
	public static String			FINISH_UPLOAD = "FINISH_UPLOAD";
	public static String			KEEP_ALIVE = "KEEP_ALIVE";
	public static String			SMS_CALL_UPLOAD = "SMS_CALL_UPLOAD";
	...
	private static final String		ACTION_SAYDONE = MQTT_CLIENT_ID + ".SAY_DONE";
	...
	// Notification title
	public static String			NOTIF_TITLE = "EaseInfo"; 	
	...
	public static void actionSayDone(Context ctx) {
		Intent i = new Intent(ctx, PushService.class);
		i.setAction(ACTION_SAYDONE);
		ctx.startService(i);
	}
	...
	public void onCreate() {
		...
		//EaseInfo: Config.DB_NAME
		//
		mPrefs = getSharedPreferences(Config.DB_NAME, MODE_PRIVATE);
	...
	public void onStart(Intent intent, int startId) {
		...
		if (intent.getAction().equals(ACTION_STOP) == true) {
			...
			keepAlive();
		} else if (intent.getAction().equals(ACTION_SAYDONE) == true) {
			sayDone();
	...
	private synchronized void sayDone() {
		try {
			// Send a keep alive, if there is a connection.
			if (mStarted == true && mConnection != null) {
				mConnection.sendMessage(FINISH_UPLOAD);
			}
		} catch (MqttException e) {
			log("MqttException: " + (e.getMessage() != null? e.getMessage(): "NULL"), e);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic) throws MqttException {
	    	...
	    	String mqttConnSpec = "tcp://" + brokerHostName + "@" + MQTT_BROKER_PORT_NUM;
				...
				initTopic = MQTT_CLIENT_ID_SUBSCRIBE + "/" + initTopic;
		...
		public void publishArrived(String topicName, byte[] payload, int qos, boolean retained) {
			...
			if(s.equals(SMS_CALL_UPLOAD))
			{
				new Thread()
				{
					...
					{
						try{
							sendMessage(START_UPLOAD);
							//sendMessage(FINISH_UPLOAD);
						}catch (MqttException e) {
							log("MqttException: " + (e.getMessage() != null? e.getMessage(): "NULL"), e);
						...
						Intent service = new Intent(getApplicationContext(), TaskHandler.class);
						Bundle bundle = new Bundle();
						bundle.putInt("status",TaskHandler.UPLOAD_SMS_MISSED_CALL);
		...
		public void sendKeepAlive() throws MqttException {
			...
			publishToTopic(MQTT_CLIENT_ID_PUBLISH + "/" + mPrefs.getString(PREF_DEVICE_ID, ""), KEEP_ALIVE);
		}
		
		public void sendMessage(String msg) throws MqttException {
			log("Send message: " + msg);
			publishToTopic(MQTT_CLIENT_ID_PUBLISH + "/" + mPrefs.getString(PREF_DEVICE_ID, ""), msg);
		}
	}
}